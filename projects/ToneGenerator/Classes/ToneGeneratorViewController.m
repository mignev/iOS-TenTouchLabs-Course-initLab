...
@synthesize frequencySelector;
@synthesize soundTouchSurface;
...
- (IBAction)pickOne:(UISegmentedControl *)sender
{
    ...
    double arrayPianoKeyFreq[5];
    
    arrayPianoKeyFreq[0] = 261.626f;
    arrayPianoKeyFreq[1] = 293.665f;
    arrayPianoKeyFreq[2] = 329.628f;
    arrayPianoKeyFreq[3] = 349.228f;
    arrayPianoKeyFreq[4] = 391.995f;
    
    //NSLog(@"arrayPianoKeyFreq = %f", arrayPianoKeyFreq[sender.selectedSegmentIndex]);
    
    frequencySlider.value = arrayPianoKeyFreq[sender.selectedSegmentIndex];
    frequency = arrayPianoKeyFreq[sender.selectedSegmentIndex];
	frequencyLabel.text = [NSString stringWithFormat:@"%4.1f Hz", frequency];
...
- (void)touchesBegan:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    // check if it's in soundTouchSurface
    
    // set frequency to the relative position
...
- (void)touchesMoved:(NSSet *)touches withEvent:(UIEvent *)event
{
    ...
    // change frequency to the relative position
}
