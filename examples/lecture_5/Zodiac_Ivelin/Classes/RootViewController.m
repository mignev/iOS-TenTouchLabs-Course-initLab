...
- (void)viewDidLoad {
	...
	UIButton *nextVC = [UIButton buttonWithType:UIButtonTypeRoundedRect];
	nextVC.frame = CGRectMake(20, 20, 150, 33);
	nextVC.tag = kButtonTag;
	[nextVC setTitle:@"Blaaa" forState: UIControlStateNormal];
	[nextVC addTarget:self action:@selector(btnClicked:) forControlEvents:UIControlEventTouchUpInside];
